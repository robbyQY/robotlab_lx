...
UNITREE_B2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/unitree/b2_description/urdf/b2_description_b2z1.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
"""Configuration of Unitree B2 with mounted Z1 arm using DC motor."""
...
#             friction=0.0,
#         )
#         # "arms": DCMotorCfg( #TODO Need to try DCMotorCFG
#         #     joint_names_expr=[
#         #         "joint.", "jointGripper"
#         #     ],
#         #     effort_limit=10.0,
...
#     },
# )
# """Configuration of Unitree B2 With Arm Z1 using DC motor.
# """
